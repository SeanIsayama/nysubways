...
const Graph = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function addTrains() {
    ...
    text.append("tspan").attr("x", 850).attr("y", 340).text(
      "On the other hand, there are only around 6400 subways cars,"
    );
