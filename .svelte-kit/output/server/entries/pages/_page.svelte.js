...
const css$2 = {
  code: ".line.svelte-9b8lz2{fill:none;stroke:steelblue;stroke-width:2}",
  map: null
};
const marginTop = 20;
...
const css = {
  code: '.header.svelte-1e4bwj8.svelte-1e4bwj8{font-family:Nunito, sans-serif;background-color:#d9d9d9;padding:20px;border-bottom:2px solid #ccc}.header-content.svelte-1e4bwj8.svelte-1e4bwj8{background-color:"#d9d9d9";display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:justify;justify-content:space-between}.section-text.svelte-1e4bwj8.svelte-1e4bwj8{-webkit-box-flex:1;flex:1;margin-right:20px}h1.svelte-1e4bwj8.svelte-1e4bwj8{font-size:50px}h2.svelte-1e4bwj8.svelte-1e4bwj8{font-size:20px;font-family:Nunito, sans-serif}.foreground.svelte-1e4bwj8.svelte-1e4bwj8{width:100%;position:relative;background-color:#f0f0f0;z-index:0}.background.svelte-1e4bwj8.svelte-1e4bwj8{width:100%;height:100vh;position:relative;outline:rgb(255, 255, 255) solid 3px;z-index:1}section.svelte-1e4bwj8.svelte-1e4bwj8{height:100vh;width:91.5%;position:relative;background-color:#f0f0f0;padding-left:60px;padding-right:60px}.progress-bars.svelte-1e4bwj8.svelte-1e4bwj8{position:fixed;top:0px;right:20px;z-index:999}.fixed-graph.svelte-1e4bwj8.svelte-1e4bwj8{position:sticky;top:50px;z-index:999}.hour-selector.svelte-1e4bwj8.svelte-1e4bwj8{position:absolute;top:25%;right:10%;-webkit-transform:translateY(-50%);transform:translateY(-50%);z-index:999}.hour-label.svelte-1e4bwj8.svelte-1e4bwj8{margin-bottom:5px}.top-stations.svelte-1e4bwj8.svelte-1e4bwj8{position:absolute;z-index:9}.top-stations.svelte-1e4bwj8 ul.svelte-1e4bwj8{list-style-type:decimal}.menu-container.svelte-1e4bwj8.svelte-1e4bwj8{position:absolute;top:5%;right:0%;width:30%;height:100%;border:2px solid rgb(145, 144, 144);border-radius:10px;-webkit-transition:border-width 0.3s;transition:border-width 0.3s}',
  map: null
};
const ScrollyTeller = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Scroller, "Scroller").$$render(
      ...
      {
        foreground: () => {
          return `<div class="foreground svelte-1e4bwj8" slot="foreground"><div class="progress-bars svelte-1e4bwj8"><p>current section: <strong>${escape(index + 1)}/${escape(count)}</strong></p> <progress${add_attribute("value", count ? (index + 1) / count : 0, 0)}></progress> <p>offset in current section: <strong>${escape(parseFloat(offset).toFixed(2))}/1</strong></p> <progress${add_attribute("value", offset || 0, 0)}></progress></div> <section style="height: 400px; background-color: #d9d9d9;" class="svelte-1e4bwj8" data-svelte-h="svelte-1nnkr4a"><div class="header svelte-1e4bwj8" background-color="#d9d9d9"><div class="header-content svelte-1e4bwj8"><div class="section-text svelte-1e4bwj8"><h1 class="svelte-1e4bwj8">A Deep Dive into MTA Data</h1> <h2 class="svelte-1e4bwj8">An interactive tool for New York City&#39;s subway system navigation</h2></div></div></div></section> <section style="height: 3600px;" class="svelte-1e4bwj8"><div class="fixed-graph svelte-1e4bwj8"><h2 class="svelte-1e4bwj8" data-svelte-h="svelte-73zzey">The Issue</h2> ${validate_component(Graph, "Graph").$$render($$result, { index, offset }, {}, {})}</div></section> <section class="svelte-1e4bwj8"><h2 class="svelte-1e4bwj8" data-svelte-h="svelte-kirs69">The Common Strategy</h2> <p data-svelte-h="svelte-1usfmoq">The most common strategy in which almost all tourists and commuters use to navitage subways efficiently is to identify when these subways are most/least populated. By doing to, people are able to avoid &quot;rush&quot; periods, and utilize the subway when it is less &quot;rushed&quot;. The line plot below   depicts the number of riders per hour throughout a randomly chosen weekday.</p> <p style="font-size: 14px; font-style: italic;" data-svelte-h="svelte-p2qpz7">*For the plot below, we have depicted data for the day February 01, 2024, obtained from data.ny.gov</p> ${validate_component(Line, "Line").$$render($$result, {}, {}, {})}</section> <section class="svelte-1e4bwj8" data-svelte-h="svelte-xzfoxw">section 3.</section> <section class="svelte-1e4bwj8"><h2 class="svelte-1e4bwj8" data-svelte-h="svelte-1nk6x48">Our Interactive Nagivation Tool</h2> ${validate_component(Map$1, "Map").$$render($$result, { busyness, geoJsonToFit, topStations }, {}, {})} <div class="hour-selector svelte-1e4bwj8"><label for="hour-select" class="hour-label svelte-1e4bwj8" data-svelte-h="svelte-1cgcp37">Change hour here:</label> <select id="hour-select" class="hour-select">${each(hours, (hour) => {
            return `<option${add_attribute("value", hour, 0)}>${escape(hour)}:00 - ${escape(hour + 1)}:00</option>`;
          })}</select></div> <div class="menu-container svelte-1e4bwj8"><div class="top-stations svelte-1e4bwj8"><h2 class="svelte-1e4bwj8" data-svelte-h="svelte-6g4uqy">Busiest stations at this time</h2> <ul class="svelte-1e4bwj8">${each(topStations, (station) => {
            return `<li>${escape(station.station_complex)}: ${escape(station.ridership)} riders</li>`;
          })}</ul></div></div></section></div>`;
        },
        background: () => {
          return `<div class="background svelte-1e4bwj8" slot="background" data-svelte-h="svelte-afik7u"></div>`;
        }
      }
    )}`;
  } while (!$$settled);
